      ...
      <div>
        <div className='about-container' >
          ...
          <div className={isToggled ? 'about-details-dark-mode' :'about-details'}>
            ...
            <p className={isToggled ? 'details-dark-mode' : 'details'}>
              Hi! I'm Kehinde Temitayo, also known as Benkenny. I'm a self-taught frontend web developer with a strong focus on building interactive and responsive interfaces using React and Next.js. I enjoy turning ideas into smooth, user-friendly experiences and tackling real-world problems through clean, maintainable code. Beyond coding, I love playing the piano, making music, and enjoying games in my free time.
            </p>
          </div>
        </div>
